...
Each directory contains one study's recorded inputs, results and available plots. New local runs stay in `../runs/`.
...
| topology-mixtures | [Browse](topology-mixtures/README.md) |
| topology-sparsity | [Browse](topology-sparsity/README.md) |
