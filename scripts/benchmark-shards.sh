...
usage() {
  cat <<'EOF'
Usage: bash scripts/benchmark-shards.sh [options] SUITE [-- RUN_OPTIONS...]
...
The default output is a fresh directory under reports/local-shards/.
EOF
}
