...
from hypothesis_helm.benchmarking.charts.workload import MULTIPLICITY, VERSION, load_inputs, source_digest
...
def run(argv: list[str] | None = None, *, workspace: FixtureWorkspace | None = None) -> int:
    ...
    if args.plot_only:
        from hypothesis_helm.benchmarking.reporting.plots import plot
