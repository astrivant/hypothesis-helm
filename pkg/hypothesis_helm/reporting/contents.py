...
def with_contents(document: str) -> str:
    """
    ...
    Returns:
        str: Markdown with linked sections through level three after its title. Long lists
    ...
    sections = [heading for heading in headings if heading != title and heading[1] <= 3]
    if not sections:
        sections = headings[:1]
