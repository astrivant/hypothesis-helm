# Retained bitnami chart tests

This run supplies the [combined report](../../bitnami.md) and [PDF](../../bitnami.pdf).
...
- `finalize.py`: aggregation recipe; run with this directory and `bitnami` as arguments after all workers finish.
