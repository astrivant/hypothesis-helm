# Retained Bitnami production scan
...
The per-chart JSON is retained byte-for-byte and can contain original absolute
or temporary paths in diagnostics. Use the portable artifact links in the combined
