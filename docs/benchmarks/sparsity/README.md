...
hypothesis-helm-benchmark sparsity \
  --chart docs/benchmarks/standard-chart --count 32768 --retain 0.25 --levels 8 \
  --time-limit 9m --output reports/sparsity
~~~
...
| ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 32,768 / 32,768 | 256 | 100.00% | 0.00000 | 0.00000 | 117.83 |
| 2 | 8,192 / 8,192 | 256 | 100.00% | 0.06726 | 0.01123 | 37.19 |
| 3 | 2,048 / 2,048 | 256 | 100.00% | 0.14258 | 0.01807 | 18.81 |
| 4 | 512 / 512 | 220 | 85.94% | 0.27930 | 0.03711 | 11.79 |
| 5 | 128 / 128 | 107 | 41.80% | 0.58203 | 0.05078 | 5.50 |
| 6 | 32 / 32 | 31 | 12.11% | 0.87891 | 0.12891 | 1.62 |
| 7 | 8 / 8 | 8 | 3.12% | 0.96875 | 0.29297 | 0.46 |
| 8 | 2 / 2 | 2 | 0.78% | 0.99219 | 0.46094 | 0.19 |
