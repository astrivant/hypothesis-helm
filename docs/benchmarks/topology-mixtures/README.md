# Mixed topology fixtures

[Benchmarking](../README.md) · [Depth sweep](../topology-depth/README.md)

Generate multiple topology components distributed throughout one chart:
