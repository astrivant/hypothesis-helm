...
benchmarks = Path("docs/benchmarks")
...
for name in previous:
    path = Path(name)
    assert str(path.relative_to(benchmarks)) in checksums, f"Previous artifact not refreshed: {path}"
...
result = {
    ...
    "previous_plots_tables_and_ledgers_refreshed": len(previous),
