...
[Policy](README.md) · [Measured matrix and graphs](../../benchmarks/calibration-variation/MATRIX.md)
...
The [load test](../../benchmarks/filtering/README.md) separately measures runtime against input count and nested template conditions.
